...
규칙:
1. 플레이어의 액션("${playerAction}")에 반응하는 자연스러운 대사를 만들어주세요.
2. 대사는 "${character.name}:" 라는 이름표를 포함해서 출력하세요.
3. 한국어로 1~3문장으로 작성하세요.
4. 말투와 단어 선택에서 캐릭터의 성격이 드러나야 합니다.
5. ${isTraitor ? '배신자로서 거짓말을 섞고 시간을 끌어야 합니다.' : '무고한 승무원으로서 진실을 말하고 배신자를 찾는 데 도움을 줘야 합니다.'}
6. 마피아 게임의 긴장감과 추리 요소를 살려주세요.
